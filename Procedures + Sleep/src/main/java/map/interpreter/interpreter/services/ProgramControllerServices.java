...
public class ProgramControllerServices {
    ...
    private void initialize() {
        ...
        textArea.setText("programStates2.log");
    }
    ...
    // Set Procedure List
    public void setProcedureList(List<IProcedure> procedureList) {
    ...
    private void launchDashboard(IStmt stmt) {
        try {
            ...
            controller.initializeDashboard(stmt, procedureList, textArea.getText());
        ...
        } catch (IOException | MyStackException | MyDictionaryException e) {
