...
// PACKAGES & IMPORTS //
////////////////////////
package map.interpreter.interpreter.domain.datastructures.dictionary;
...
public class MyDictionary<K, V> implements MyIDictionary<K, V> {
    ...
    // Put All
    // Adds all new (key, value) pairs to the dictionary
    // Throws an exception if one key is already present inside the dictionary
    @Override
    public void putAll(Map<K, V> newContent) {
