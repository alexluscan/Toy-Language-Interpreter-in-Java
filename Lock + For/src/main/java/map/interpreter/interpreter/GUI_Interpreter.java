...
public class GUI_Interpreter extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        IStmt ex11 = new CompStmt(new VarDeclStmt("a", new RefType(new IntType())), new CompStmt(new HeapAllocStmt("a", new ValueExp(new IntValue(20))), new CompStmt(new ForStmt("v", new ValueExp(new IntValue(0)), new ValueExp(new IntValue(3)), new ArithExp(new VarExp("v"), new ValueExp(new IntValue(1)), "+"), new ForkStmt(new CompStmt(new PrintStmt(new VarExp("v")), new AssignStmt("v", new ArithExp(new VarExp("v"), new HeapReadExp(new VarExp("a")), "*"))))), new PrintStmt(new HeapReadExp(new VarExp("a"))))));
                                                ...
                                                new CompStmt(new HeapAllocStmt("v2", new ValueExp(new IntValue(30))),
                                                        new CompStmt(new CreateLockStmt("x"),
                                                                new CompStmt(new ForkStmt(
                                                                        ...
                                                                        new CompStmt(new CreateLockStmt("q"),
                                                                                new CompStmt(new ForkStmt(
                                                                                        new CompStmt(new ForkStmt(
                                                                                                new CompStmt(new LockStmt("q"),
                                                                                                        new CompStmt(new HeapWriteStmt("v2",
                                                                                                                new ArithExp(
